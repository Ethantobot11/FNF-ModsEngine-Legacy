...
class NoteSplashDebugState extends MusicBeatState
{
	...
	override function create()
	{
        ...
        var text FlxText = new FlxText(0, 520, FlxG.width,
            "Press B To Reset Animation\nPress A Twice To Save To The Loaded Note Splash PNG's Floder\nLEFT/RIGHT Change Selected Note - Arrow Keys To Change Offset (Hold C for 10x)\nY + C/X - Copy & Paste", 16);
        #end
		...
		#if android
		addVirtualPad(BOTH_FULL, A_B_C_D_V_X_Y);
		#end

...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	'UP,DOWN,LEFT,RIGHT - Move Camera (Hold B To Move 4x Faster)
	\nX/C - Zoom Out/In
	\nZ - Reset Camera
	...
	\nZ - Reset Camera
	\nY - Toggle Speech Bubble
	\nUP,DOWN,LEFT,RIGHT - Move Looping Animation Offset (Red)
	\nUP,DOWN,LEFT,RIGHT + Press A Once (Twice To Closed) - Move Idle/Finished Animation Offset (Blue)
	...
	override function create() {
		...
		#if android
		addVirtualPad(BOTH_FULL, A_B_C_X_Y_Z);
		#end
